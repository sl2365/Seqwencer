...
Seqwencer is a dual sequencer plugin, VST3 only at present, with ease of use and flexibility in mind. You can use it on its own as a plugin in a DAW, where the built in FX can be sequenced individually, just drag any parameter starting with :: to the relevant target panel. Draw your sequence using the mouse, just click and drag. Several FX are built into the sequencer:
- Gate / Noise gate
