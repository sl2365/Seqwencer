...
:run_build
title Seqwencer - Stage 3.8.0 Build
...
echo.
echo Seqwencer 64-bit VST3 - Stage 3.8.0 Build
echo ========================================
echo.
...
echo   - PASS: Sequencer timing, Gate, Delay, Reverb, Pan, Filter, Pitch, routing and HOST SYNC tests passed
