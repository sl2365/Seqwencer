...
:run_build
title Seqwencer - Stage 3.9.1 Build
...
echo.
echo Seqwencer 64-bit VST3 - Stage 3.9.1 Build
echo ========================================
echo.
...
echo   - PASS: Sequencer timing, Gate, Delay, Reverb, Pan, Filter, Pitch, Distortion, routing and HOST SYNC tests passed
