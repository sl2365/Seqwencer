...
:run_build
title Seqwencer - Stage 3.5.0 Build
...
echo.
echo Seqwencer 64-bit VST3 - Stage 3.5.0 Build
echo ========================================
echo.
...
echo   - PASS: Sequencer timing, Gate, Delay, Reverb, routing and HOST SYNC tests passed
